              ...
              <div class="charm-body-content-main">
                <div class="charm-form-container">
                  ...
                  <div class="form-container-header">
                    ...
                    <div class="form-container-header-description">通过帐号密码登录，切换为 <a href="javascript:;">手机验证码登录</a>
                    </div>
                  </div>
                  <!-- 2.2 登录表单 -->
...
import { PictureFilled, User, Lock } from '@element-plus/icons-vue'
...
// watch(() => loginForm, (newValue, oldvalue) => {
//   if (newValue.username.length > 0 && newValue.password.length > 5 && newValue.captcha.length > 0) {
