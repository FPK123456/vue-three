...
axios.defaults.timeout = 120000 // 默认为0，永不超时
axios.defaults.validateStatus = (status) => status >= 200 && status < 400 // 默认[200,300)

/* =========================================================== #
# ******************* 二、封装POST/DELETE/PUT/GET/批量删除 五大请求方法
# ============================================================ */
...
export function axiosBatchDel (opt) {
  return ajax(opt, 'DELETE2')
}
